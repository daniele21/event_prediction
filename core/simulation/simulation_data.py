...
def enrich_data_for_simulation(data, probabilities):
    ...
    result['bet_prob_1'] = 1/result['bet_1']
    result['bet_prob_X'] = 1 / result['bet_X']
    result['bet_prob_2'] = 1 / result['bet_2']
    result['bet_prob_1X'] = 1 / result['bet_1X']
    result['bet_prob_X2'] = 1 / result['bet_X2']
    result['bet_prob_12'] = 1 / result['bet_12']
    ...
    result = result[['league', 'season', 'match_day', 'match_n',
                     ...
                     'bet_X2', 'my_bet_X2',
                     'bet_12', 'my_bet_12',
                     'bet_prob_1', 'bet_prob_X', 'bet_prob_2',
                     'bet_prob_1X', 'bet_prob_X2', 'bet_prob_12',
    ]]
